...
# if (exists('running_enrich_go()')) {
  ...
  if (length(nrow(running_enrich_go())) > 0) {
...
# if (base::exists('running_path()')) {
  
  if (length(nrow(running_path()) > 0)) {
...
# if (exists('running_do()')) {
  ...
  if (length(nrow(running_do() %>% as_tibble())) > 0) {
