...
To calculate the similarity between two sets of phenotype terms (e.g, disease, gene, or DECIPHER CNV), we use Resnik's symmetrical similarity. To aggregate the results into a single score, Best Match Average (BMA) is used.
